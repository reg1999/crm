        ...
        <ul class="sidebar-menu" data-widget="tree">
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li name="notice"><a href="/notice/list.do"><i class="fa fa-circle-o"></i>公告管理</a></li>
                    <li name="courseOrder"><a href="/courseOrder/list.do"><i class="fa fa-circle-o"></i>课程管理</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
